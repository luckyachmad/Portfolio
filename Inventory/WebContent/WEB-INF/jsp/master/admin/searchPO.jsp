...
<body>
	...
	<div id="container-full">
		...
		<div id="main-full">
				...
				<table class="second">
					...
					<c:forEach var="po" items="${po}" varStatus="status">
						<tr>
							...
							<td><a class="view" href="<c:url value="/master/admin/detailPo?id=${po.id}"/>">${po.id}</a></td>
							<td>${po.supplier.name}</td>
							<td>${po.tglPo}</td>
							<td><a class="view" href="<c:url value="/master/admin/detailPo?id=${po.id}"/>">view</a></td>							
						</tr>
					</c:forEach>
					<c:if test="${empty po}">
               	 		<tr>
			...
			<a class="button" href="<c:url value="/master/admin/detailPo"/>">Create Purchase Order</a>
			<br/><br/>
